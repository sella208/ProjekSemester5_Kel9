                                ...
                                <table id="datatb" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php echo anchor('dosenwali/hapus/'. $dsw->id_doswal, '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>') ?></td>
                ...
                <div class="modal-dialog" role="document">
                     <div class="modal-content">
                       <div class="modal-header">
                           <h4 class="modal-tittle" id="exampleModalLabel">FORM INPUT DATA MAHASISWA</h4>
