...
<body>
                                ...
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control form-white" data-placeholder="Ch oose a color..." name="category-color">
    ...
    <script src="<?php echo base_url()?>admin/assets/js/init/weather-init.js"></script>

    <script src="https://cdn.jsdelivr.net/npm/moment@2.22.2/moment.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/fullcalendar@3.9.0/dist/fullcalendar.min.js"></script>
    <script src="<?php echo base_url()?>admin/assets/js/init/fullcalendar-init.js"></script>
