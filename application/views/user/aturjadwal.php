...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?php echo base_url()?>user/assets/libs/fullcalendar/dist/fullcalendar.min.css" rel="stylesheet" />
    <link href="<?php echo base_url()?>user/assets/extra-libs/calendar/calendar.css" rel="stylesheet" />
...
<body>
    ...
    <script src="<?php echo base_url()?>user/dist/js/jquery.ui.touch-punch-improved.js"></script>
    <script src="<?php echo base_url()?>user/dist/js/jquery-ui.min.js"></script>
    ...
    <script src="<?php echo base_url()?>user/dist/js/custom.min.js"></script>
     <!-- this page js -->
    <script src="<?php echo base_url()?>user/assets/libs/moment/min/moment.min.js"></script>
    <script src="<?php echo base_url()?>user/assets/libs/fullcalendar/dist/fullcalendar.min.js"></script>
    <script src="<?php echo base_url()?>user/dist/js/pages/calendar/cal-init.js"></script>
</body>
